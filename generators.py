...
class LCERandomGenerator():
    ...
    def generate_random(self):
        calculated_index = (self.last_calculated_index * self.a + self.c) % self.m
        value = int(self.e_value[calculated_index:calculated_index + self.decimals]) / (10 ** self.decimals)
...
class ESimpleRandomGenerator():
    ...
    def generate_random(self):
        value = int(self.e_value[self.last_calculated_index:self.last_calculated_index + self.decimals]) / (10 ** self.decimals)
